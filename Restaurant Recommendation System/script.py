...
# Code to insert food types into a data structure (LinkedList) here. The data is in data.py
...
# Code to insert restaurant data into a data structure (LinkedList of LinkedLists) here. The data is in data.py
...
# Code for user interaction here
while len(selected_food_type) == 0:
    ...
    if len(matching_types) == 1:
        ...
        # After finding food type, code for retrieving restaurant data here
        if select_type == 'y':
